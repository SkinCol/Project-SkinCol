<%-- 
    ...
    Created on : 10/06/2019, 01:50:39 PM
    Author     : angel
--%>
                ...
                <div class="card">
                  ...
                  <div class="card-body px-lg-5 pt-5">
                    ...
                    <form class="mb-3 pb-1" name="formulario" id="formulario" method="POST">
                      ...
                      <input type="text" name="nombre" id="nombre" class="form-control" placeholder="" value="${lista[0].Nombre}">


                      <hr>
                      <button class="btn btn-outline-success btn-block" type="submit"><i class="fa fa-save"></i>
                        Guardar</button>
