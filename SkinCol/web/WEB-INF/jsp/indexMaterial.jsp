<%-- 
    ...
    Created on : 25/06/2019, 04:31:48 PM
    Author     : angel
--%>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row justify-content-end">
                <div class="col-md-12 ">
                  <a class="btn btn-success" href="agregarMaterial.htm">
              ...
              <table class="table table-hover">
                ...
                <div id="listadoregistros">
                  <table id="tbllistado" class="table table-striped">
                    ...
                    <tr>
                        <td>${dato.IdMaterial}</td> 
                        <td>${dato.Nombre}</td>
                        <td>${dato.Descripcion}</td>
                        <td>
                            <a href="editarMaterial.htm?IdMaterial=${dato.IdMaterial}" class="btn btn-warning">Editar</a>
                            <a onclick="return confirm ('Esta seguro?');" href="deleteMaterial.htm?IdMaterial=${dato.IdMaterial}" class="btn btn-danger">Eiminar</a>
                        </td>
                    </tr>
                </c:forEach>
                  </tbody>
