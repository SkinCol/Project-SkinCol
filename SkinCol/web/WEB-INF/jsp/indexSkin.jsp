<%-- 
    Document   : indexSkin
    Created on : 10/06/2019, 01:49:36 PM
    Author     : angel
--%>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row justify-content-end">
                <div class="col-md-12 ">
                  <a class="btn btn-success" href="agregarSkin.htm">
              ...
              <table class="table table-hover">
                ...
                <c:forEach var="dato" items="${lista}">
                    <tr>
                        ...
                        <td>
                            <a href="editarSkin.htm?IdSkin=${dato.IdSkin}" class="btn btn-warning">Editar</a>
                            <a onclick="return confirm('Esta seguro?');" href=" deleteSkin.htm?IdSkin=${dato.IdSkin}" class="btn btn-danger">Eiminar</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
