<%-- 
    ...
    Created on : 12/07/2019, 07:30:03 PM
    Author     : angel
--%>
              ...
              <div class="panel-body" id="formularioregistros">
                <div class="card">
                  ...
                  <h5 class="card-header info-color white-text text-center py-4">
                    <strong>Agregar Departamento</strong>
                  </h5>
                  ...
                  <div class="card-body px-lg-5 pt-5">
                    ...
                    <form class="mb-3 pb-1" name="formulario" id="formulario" method="POST">
                      ...
                      <hr>
                      <button class="btn btn-outline-success btn-block" type="submit" value="agregarMaterial"><i class="fa fa-save"></i>
                        Guardar</button>
                      <a class="btn btn-outline-danger btn-block" href="indexDepartamento.htm"><i
