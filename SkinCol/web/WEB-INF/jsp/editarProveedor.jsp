                ...
                <div class="card">
                  ...
                  <div class="card-body px-lg-5 pt-5">
                    ...
                    <form class="mb-3 pb-1" name="formulario" id="formulario" method="POST">
                      ...
                      <label>Nombre</label>
                      <input type="text" class="form-control" name="Nombre" id="Nombre" maxlength="50"  value="${lista[0].Nombre}">
                  </div>
                  <div class="form-group col-sm-12 col-md-6 col-xl-12">
                      <label>NIT</label>
                      <input type="text" name="NIT" id="NIT" class="form-control" value="${lista[0].NIT}">
                  </div>
                  <div class="form-group col-sm-12 col-md-6 col-xl-12">
                    <label>Dirección</label>
                    <input type="text" name="Direccion" id="Direccion" class="form-control" value="${lista[0].Direccion}">
                  </div>
                  <div class="form-group col-sm-12 col-md-6 col-xl-12">
                      <label>Correo</label>
                      <input type="text" name="Correo" id="Correo" class="form-control" value="${lista[0].Correo}">
                  </div>
                  <div class="form-group col-sm-12 col-md-6 col-xl-12">
                    <label>Telefono</label>
                    <input id="Telefono" name="Telefono" class="form-control" type="text" value="${lista[0].Telefono}">
                  </div>
                      <hr>
                      <button class="btn btn-outline-success btn-block" type="submit" value="Guardar"><i class="fa fa-save"></i>
                        Guardar</button>
                      <a class="btn btn-outline-danger btn-block" href="indexProveedor.htm"><i
