          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row justify-content-">
                <div class="col-md-12 ">
                  <a class="btn btn-success" href="agregarProveedor.htm">
                ...
                <div id="listadoregistros">
                  <table id="tbllistado" class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>${dato.Telefono}</td>
                        <td>
                            <a href="editarProveedor.htm?IdProveedor=${dato.IdProveedor}" class="btn btn-warning">Editar</a>
                            <a onclick="return confirm ('Esta seguro?');" href="deleteProveedor.htm?IdProveedor=${dato.IdProveedor}" class="btn btn-danger">Eiminar</a>
                        </td>
                    </tr>
                </c:forEach>
                  </table>
