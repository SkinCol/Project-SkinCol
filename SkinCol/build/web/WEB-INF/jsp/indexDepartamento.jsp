<%-- 
    Document   : inexDepartamento
    Created on : 12/07/2019, 07:30:38 PM
    Author     : angel
--%>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row justify-content-end">
                <div class="col-md-12 ">
                  <a class="btn btn-success" href="agregarDepartamento.htm">
                ...
                <div id="listadoregistros">
                  <table id="tbllistado" class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>${dato.Nombre}</td>
                        <td>
                            <a href="editarDepartamento.htm?IdDepartamento=${dato.IdDepartamento}" class="btn btn-warning">Editar</a>
                            <a onclick="return confirm ('Esta seguro?');" href="deleteDepartamento.htm?IdDepartamento=${dato.IdDepartamento}" class="btn btn-danger">Eiminar</a>
                        </td>
                    </tr>
                </c:forEach>
                  </tbody>
