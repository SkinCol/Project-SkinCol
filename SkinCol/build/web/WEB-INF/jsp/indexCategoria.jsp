<%-- 
    Document   : indexCategoria
    Created on : 6/06/2019, 02:43:34 PM
    Author     : angel
--%>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row justify-content-end">
                <div class="col-md-12 ">
                  <a class="btn btn-success" href="agregarCategoria.htm">
                ...
                <div id="listadoregistros">
                  <table id="tbllistado" class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>${dato.Nombre}</td>
                        <td>
                            <a href="editarCategoria.htm?IdCategoria=${dato.IdCategoria}" class="btn btn-warning">Editar</a>
                            <a onclick="return confirm ('Esta seguro?');" href="deleteCategoria.htm?IdCategoria=${dato.IdCategoria}" class="btn btn-danger">Eiminar</a>
                        </td>
                    </tr>
                </c:forEach>
                  </tbody>
