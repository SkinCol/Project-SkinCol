<%-- 
    Document   : agregarEnvio
    Created on : 1/08/2019, 01:12:02 PM
    Author     : angel
--%>
                  ...
                  <div class="card-body px-lg-5 pt-5">
                    ...
                    <form class="mb-3 pb-1" name="formulario" id="formulario" method="POST">
                      ...
                      <select class="browser-default custom-select mb-4" name="IdUsuario" id="IdUsuario">                       
                            ...
                            <option value="${dato.IdUsuario}">${dato.Nombres} </option>
                            </c:forEach>
                        </select>
                      ...
                      <select class="browser-default custom-select mb-4" name="IdFactura" id="IdFactura">                       
                            <c:forEach var="dato" items="${lista}">
                            <option value="${dato.IdFactura}">${dato.IdFactura} </option>
                            </c:forEach>
                        </select>
                      
                      
                     <label for="Nombre">Fecha</label>
                      <input type="date" name="Fecha" id="nombre" class="form-control" placeholder="">
