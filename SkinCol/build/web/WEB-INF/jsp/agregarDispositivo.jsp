<%-- 
    Document   : agregarDispositivo
    Created on : 19/07/2019, 03:41:11 PM
    Author     : angel
--%>
                ...
                <div class="card">
                  ...
                  <div class="card-body px-lg-5 pt-5">
                    ...
                    <form class="mb-3 pb-1" name="formulario" id="formulario" method="POST">
                      ...
                      <label>Modelo</label>
                      <input type="text" class="form-control" name="Modelo" id="Nombre" maxlength="50" placeholder="Nombre" required>
                  </div>
                  <div class="form-group col-sm-12 col-md-6 col-xl-12">
                      <label>Marca</label>
                      <input type="text" name="Marca" id="NIT" class="form-control" placeholder="Ingrese el número NIT">
                  </div>
                  <div class="form-group col-sm-12 col-md-6 col-xl-12">
                    <label>Tipo</label>
                    <input type="text" name="Tipo" id="Direccion" class="form-control" placeholder="Ingrese la Dirección">
                  </div>
                  <div class="form-group col-sm-12 col-md-6 col-xl-12">
                      <label>Imagen</label>
                      <input type="text" name="Imagen" id="Correo" class="form-control" placeholder="Ingrese el Correo">
                  </div>
                      <hr>
                      <button class="btn btn-outline-success btn-block" type="submit" value="agregarDispositivo"><i class="fa fa-save"></i>
                        Guardar</button>
